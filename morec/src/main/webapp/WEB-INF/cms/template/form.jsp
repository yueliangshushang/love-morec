...
<tr>
<td width="150" align="right" nowrap="nowrap">文件名：</td>
<td colspan="2"><form:input path="fileName" cssClass="input5 fontMar"/></td>
</tr>
<tr>
<td width="150" align="right" nowrap="nowrap">排序：</td>
<td colspan="2"><form:input path="sort" cssClass="input5 fontMar"/></td>
</tr>
<tr>
