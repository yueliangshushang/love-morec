 ...
 <div class="mainNav table">
	<h5 class="menu_head">
		...
		<span style="width:auto;">欢迎页面</span>
          ...
          <li><a href="${ctx}/resource/list" target="main"><span class="allIco ico15"></span>资源管理</a></li>
          <li><a href="${ctx}/resource/recycle" target="main"><span class="allIco ico15"></span>回收站</a></li>
        </ul>
   </div>
</shiro:hasRole>
</div>
