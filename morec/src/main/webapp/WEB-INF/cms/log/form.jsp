...
<tr>
<td width="240" align="right" nowrap="nowrap"><span class="red">*</span>站点名称：</td>
<td colspan="2"><form:input path="name" cssClass="input5 fontMar"/></td>
</tr>

<tr>
<td width="240" align="right" nowrap="nowrap">站点描述：</td>
<td colspan="2"><form:input path="descr" cssClass="input5 fontMar"/></td>
</tr>
<tr>
<td width="240" align="right" nowrap="nowrap">版权：</td>
<td colspan="2"><form:input path="copyRight" cssClass="input5 fontMar"/></td>
</tr>
